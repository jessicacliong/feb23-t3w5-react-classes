...
// Extend fromm Component to make sure that this works as a React Component
export default class PokemonDisplay extends React.Component{
constructor(props){
  super(props);

    // State stores data per component, other states can't access it
    // To pass through data we have to use props
    this.state = {
      pokemonName: null
    }
  }
